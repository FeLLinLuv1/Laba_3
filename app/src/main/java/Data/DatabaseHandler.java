...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void  addClas (Classmates classmates){
        ...
        contentValues.put(Util.KEY_FIO, classmates.getFIO());
    ...
    public Classmates getClas(int id){
        ...
        Cursor cursor = db.query(Util.TABLE_NAME, new String[] {Util.KEY_ID, Util.KEY_FIO, Util.KEY_TIME},
    ...
    public List<Classmates> getAllClas(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                classmates.setFIO(cursor.getString(1));
                classmates.setTime(cursor.getString(2));
